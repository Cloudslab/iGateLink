...
public class JobSubmissionRequest extends org.cloudbus.foggatewaylib.aneka.wsdl.Request {
	...
	protected void fromSoapResponse(JobSubmissionRequest object, AttributeContainer response) {
		...
		object.setJobs(jobsValue != null ? (org.cloudbus.foggatewaylib.aneka.wsdl.ArrayOfJob) KSoap2Utils.getObject(new org.cloudbus.foggatewaylib.aneka.wsdl.ArrayOfJob(), (AttributeContainer) jobsValue) : null);
	}
