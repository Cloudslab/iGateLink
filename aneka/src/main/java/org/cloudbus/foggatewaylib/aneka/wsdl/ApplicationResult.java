...
public class ApplicationResult extends org.cloudbus.foggatewaylib.aneka.wsdl.Result {
	...
	protected void fromSoapResponse(ApplicationResult object, AttributeContainer response) {
		...
		object.setJobs(jobsValue != null ? (org.cloudbus.foggatewaylib.aneka.wsdl.ArrayOfJobResult) KSoap2Utils.getObject(new org.cloudbus.foggatewaylib.aneka.wsdl.ArrayOfJobResult(), (AttributeContainer) jobsValue) : null);
		...
		object.setState(stateValue != null ? (org.cloudbus.foggatewaylib.aneka.wsdl.ApplicationStatus) KSoap2Utils.getObject(new org.cloudbus.foggatewaylib.aneka.wsdl.ApplicationStatus(), (AttributeContainer) stateValue) : null);
	}
