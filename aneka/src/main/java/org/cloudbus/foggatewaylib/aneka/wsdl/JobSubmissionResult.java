...
public class JobSubmissionResult extends org.cloudbus.foggatewaylib.aneka.wsdl.Result {
	...
	protected void fromSoapResponse(JobSubmissionResult object, AttributeContainer response) {
		...
		object.setIds(idsValue != null ? (org.cloudbus.foggatewaylib.aneka.wsdl.ArrayOfString) KSoap2Utils.getObject(new org.cloudbus.foggatewaylib.aneka.wsdl.ArrayOfString(), (AttributeContainer) idsValue) : null);
	}
