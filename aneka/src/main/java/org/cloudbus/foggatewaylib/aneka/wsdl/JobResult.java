...
public class JobResult extends org.cloudbus.foggatewaylib.aneka.wsdl.Result {
	...
	protected void fromSoapResponse(JobResult object, AttributeContainer response) {
		...
		object.setMaximumExecutionRuntime(maximumExecutionRuntimeValue != null ? (org.cloudbus.foggatewaylib.aneka.wsdl.TimeSpan) KSoap2Utils.getObject(new org.cloudbus.foggatewaylib.aneka.wsdl.TimeSpan(), (AttributeContainer) maximumExecutionRuntimeValue) : null);
		...
		object.setStatus(statusValue != null ? (org.cloudbus.foggatewaylib.aneka.wsdl.JobStatus) KSoap2Utils.getObject(new org.cloudbus.foggatewaylib.aneka.wsdl.JobStatus(), (AttributeContainer) statusValue) : null);
