...
public class JobAbortRequest extends org.cloudbus.foggatewaylib.aneka.wsdl.Request {
	...
	public JobAbortRequest() {
		super("http://www.manjrasoft.com/Aneka/v2.0/WebServices", "JobAbortRequest");
	}

	protected JobAbortRequest(String nsUri, String name) {
		super(nsUri, name);
	}
	...
	protected void fromSoapResponse(JobAbortRequest object, AttributeContainer response) {
