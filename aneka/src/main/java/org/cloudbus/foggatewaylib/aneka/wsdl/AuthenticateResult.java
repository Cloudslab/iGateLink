...
public class AuthenticateResult extends org.cloudbus.foggatewaylib.aneka.wsdl.Result {

	/** Optional property */
	private org.cloudbus.foggatewaylib.aneka.wsdl.UserCredential userCredential;
	...
	protected void fromSoapResponse(AuthenticateResult object, AttributeContainer response) {
		...
		object.setUserCredential(userCredentialValue != null ? (org.cloudbus.foggatewaylib.aneka.wsdl.UserCredential) KSoap2Utils.getObject(new org.cloudbus.foggatewaylib.aneka.wsdl.UserCredential(), (AttributeContainer) userCredentialValue) : null);
	}
	...
	public org.cloudbus.foggatewaylib.aneka.wsdl.UserCredential getUserCredential() {
		return userCredential;
	}

	public void setUserCredential(org.cloudbus.foggatewaylib.aneka.wsdl.UserCredential newValue) {
