...
public class ApplicationQueryRequest extends org.cloudbus.foggatewaylib.aneka.wsdl.Request {
	...
	protected ApplicationQueryRequest(String nsUri, String name) {
		super(nsUri, name);
	}
	...
	protected void fromSoapResponse(ApplicationQueryRequest object, AttributeContainer response) {
