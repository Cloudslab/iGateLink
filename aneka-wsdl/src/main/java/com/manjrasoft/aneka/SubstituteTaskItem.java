...
public class SubstituteTaskItem extends TaskItem {
    ...
    protected void fromSoapResponse(SubstituteTaskItem object, AttributeContainer response) {
        ...
        object.setParameters(parametersValue != null ? (com.manjrasoft.aneka.ArrayOfTaskParameter) KSoap2Utils.getObject(new com.manjrasoft.aneka.ArrayOfTaskParameter(), (AttributeContainer) parametersValue) : null);
