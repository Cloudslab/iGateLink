...
public class ApplicationSubmissionRequest extends Request {
	...
	protected void fromSoapResponse(ApplicationSubmissionRequest object, AttributeContainer response) {
		...
		object.setMetadata(metadataValue != null ? (PropertyGroup) KSoap2Utils.getObject(new PropertyGroup(), (AttributeContainer) metadataValue) : null);
		Object sharedFilesValue = KSoap2Utils.getProperty((SoapObject) response, "SharedFiles");
		object.setSharedFiles(sharedFilesValue != null ? (ArrayOfFile) KSoap2Utils.getObject(new ArrayOfFile(), (AttributeContainer) sharedFilesValue) : null);
		Object qosValue = KSoap2Utils.getProperty((SoapObject) response, "QoS");
		object.setQos(qosValue != null ? (QoS) KSoap2Utils.getObject(new QoS(), (AttributeContainer) qosValue) : null);
	}
