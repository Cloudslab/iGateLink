...
public class QueryJobStatus extends SoapObject implements Deserializable {

	/** Optional property */
	private com.manjrasoft.aneka.JobQueryRequest request;

	public QueryJobStatus() {
		super("http://www.manjrasoft.com/Aneka/v2.0/WebServices", "QueryJobStatus");
	}

	protected QueryJobStatus(String nsUri, String name) {
		super(nsUri, name);
	}
	...
	protected void fromSoapResponse(QueryJobStatus object, AttributeContainer response) {
	...
	public String toString() {
		StringBuilder sb = new StringBuilder("QueryJobStatus [");
