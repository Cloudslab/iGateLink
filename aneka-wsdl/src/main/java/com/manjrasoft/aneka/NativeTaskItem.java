...
public class NativeTaskItem extends TaskItem {
    ...
    protected void fromSoapResponse(NativeTaskItem object, AttributeContainer response) {
        ...
        object.setDependencies(dependenciesValue != null ? (com.manjrasoft.aneka.ArrayOfTaskDependency) KSoap2Utils.getObject(new com.manjrasoft.aneka.ArrayOfTaskDependency(), (AttributeContainer) dependenciesValue) : null);
